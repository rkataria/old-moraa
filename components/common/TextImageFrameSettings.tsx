...
export function TextImageFrameSettings() {
  ...
  useEffect(() => {
    setSelectedKeys(new Set([currentFrame?.config.layoutType]))
  }, [currentFrame?.config.layoutType])
  if (!currentFrame || currentFrame.type !== ContentType.TEXT_IMAGE) return null
