...
export function useYjsStore({
  ...
  const { yDoc, yStore, meta, room } = useMemo(() => {
    ...
    return {
      ...
      yStore: _yStore,
      meta: _meta,
      room: new YPartyKitProvider(hostUrl, roomId, _yDoc, {
        connect: true, // false, // do not connect immediately, use provider.connect() when required
        awareness: new awarenessProtocol.Awareness(_yDoc), // use your own Yjs awareness instance
