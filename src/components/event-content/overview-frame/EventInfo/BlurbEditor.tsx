...
export function BlurbEditor({
  ...
  const startWithAi = () => {
    ...
    if (!editor) return
    editor.commands.setContent(initalContentAiWriter)
  }
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-1 h-8">
        ...
        <RenderIf isTrue={!!onEmptyContent}>
          <Button
            onClick={startWithAi}
            ...
            startContent={
              <svg
                ...
                className="w-[20px] h-[20px] text-gray-100">
                <path
      ...
      <div
        ...
        <RichTextEditor
          ...
          hideSideBar
          onEmptyContent={(_editor) => {
            setOnEmptyContent(true)
            setEditor(_editor)
          }}
          classNames={{
            container: cn(
